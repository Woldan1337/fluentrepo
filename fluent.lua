-- Bundled Fluent UI Library

-- Begin Module: Creator.lua
...
-- Begin Module: Acrylic/AcrylicBlur.lua
local Acrylic_AcrylicBlur = (function()
...
-- Begin Module: Acrylic/AcrylicPaint.lua
local Acrylic_AcrylicPaint = (function()
local Creator = require(script.Parent.Parent.Creator)
...
-- Begin Module: Acrylic/CreateAcrylic.lua
local Acrylic_CreateAcrylic = (function()
...
-- Begin Module: Acrylic/init.lua
local Acrylic_init = (function()
local Acrylic = {
...
-- Begin Module: Acrylic/Utils.lua
local Acrylic_Utils = (function()
...
-- Begin Module: Components/Assets.lua
local Components_Assets = (function()
return {
...
-- Begin Module: Components/Button.lua
local Components_Button = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local New = Creator.New
...
-- Begin Module: Components/Dialog.lua
local Components_Dialog = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Components/Element.lua
local Components_Element = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local New = Creator.New
...
-- Begin Module: Components/Notification.lua
local Components_Notification = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local Acrylic = require(Root.Acrylic)
...
-- Begin Module: Components/Section.lua
local Components_Section = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Components/Tab.lua
local Components_Tab = (function()
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
...
-- Begin Module: Components/Textbox.lua
local Components_Textbox = (function()
...
-- Begin Module: Components/TitleBar.lua
local Components_TitleBar = (function()
local Root = script.Parent.Parent
...
-- Begin Module: Components/Window.lua
local Components_Window = (function()
...
-- Begin Module: Elements/Button.lua
local Elements_Button = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements/Colorpicker.lua
local Elements_Colorpicker = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Elements/Dropdown.lua
local Elements_Dropdown = (function()
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")
local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
local Camera = game:GetService("Workspace").CurrentCamera
...
-- Begin Module: Elements/init.lua
local Elements_init = (function()
local Elements = {}
...
-- Begin Module: Elements/Input.lua
local Elements_Input = (function()
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements/Keybind.lua
local Elements_Keybind = (function()
local UserInputService = game:GetService("UserInputService")
...
-- Begin Module: Elements/Paragraph.lua
local Elements_Paragraph = (function()
local Root = script.Parent.Parent
local Components = Root.Components
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
...
-- Begin Module: Elements/Slider.lua
local Elements_Slider = (function()
local UserInputService = game:GetService("UserInputService")
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Elements/Toggle.lua
local Elements_Toggle = (function()
local TweenService = game:GetService("TweenService")
local Root = script.Parent.Parent
local Creator = require(Root.Creator)
...
-- Begin Module: Packages/Flipper/BaseMotor.lua
local Packages_Flipper_BaseMotor = (function()
local RunService = game:GetService("RunService")
...
-- Begin Module: Packages/Flipper/BaseMotor.spec.lua
local Packages_Flipper_BaseMotor.spec = (function()
return function()
	local RunService = game:GetService("RunService")
...
-- Begin Module: Packages/Flipper/GroupMotor.lua
local Packages_Flipper_GroupMotor = (function()
local BaseMotor = require(script.Parent.BaseMotor)
...
-- Begin Module: Packages/Flipper/GroupMotor.spec.lua
local Packages_Flipper_GroupMotor.spec = (function()
return function()
...
-- Begin Module: Packages/Flipper/init.lua
local Packages_Flipper_init = (function()
local Flipper = {
...
-- Begin Module: Packages/Flipper/Instant.lua
local Packages_Flipper_Instant = (function()
local Instant = {}
...
-- Begin Module: Packages/Flipper/Instant.spec.lua
local Packages_Flipper_Instant.spec = (function()
return function()
	local Instant = require(script.Parent.Instant)
...
-- Begin Module: Packages/Flipper/isMotor.lua
local Packages_Flipper_isMotor = (function()
...
-- Begin Module: Packages/Flipper/isMotor.spec.lua
local Packages_Flipper_isMotor.spec = (function()
return function()
	local isMotor = require(script.Parent.isMotor)
...
-- Begin Module: Packages/Flipper/Linear.lua
local Packages_Flipper_Linear = (function()
local Linear = {}
...
-- Begin Module: Packages/Flipper/Linear.spec.lua
local Packages_Flipper_Linear.spec = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
...
-- Begin Module: Packages/Flipper/Signal.lua
local Packages_Flipper_Signal = (function()
local Connection = {}
...
-- Begin Module: Packages/Flipper/Signal.spec.lua
local Packages_Flipper_Signal.spec = (function()
return function()
	local Signal = require(script.Parent.Signal)
...
-- Begin Module: Packages/Flipper/SingleMotor.lua
local Packages_Flipper_SingleMotor = (function()
local BaseMotor = require(script.Parent.BaseMotor)
...
-- Begin Module: Packages/Flipper/SingleMotor.spec.lua
local Packages_Flipper_SingleMotor.spec = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Instant = require(script.Parent.Instant)
...
-- Begin Module: Packages/Flipper/Spring.lua
local Packages_Flipper_Spring = (function()
...
-- Begin Module: Packages/Flipper/Spring.spec.lua
local Packages_Flipper_Spring.spec = (function()
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Spring = require(script.Parent.Spring)
...
-- Begin Module: Themes/Amethyst.lua
local Themes_Amethyst = (function()
return {
	Name = "Amethyst",
...
-- Begin Module: Themes/Aqua.lua
local Themes_Aqua = (function()
return {
	Name = "Aqua",
...
-- Begin Module: Themes/Dark.lua
local Themes_Dark = (function()
return {
	Name = "Dark",
...
-- Begin Module: Themes/Darker.lua
local Themes_Darker = (function()
return {
	Name = "Darker",
...
-- Begin Module: Themes/init.lua
local Themes_init = (function()
local Themes = {
	Names = {
		"Dark",
		"Darker",
...
-- Begin Module: Themes/Light.lua
local Themes_Light = (function()
return {
	Name = "Light",
...
-- Begin Module: Themes/Rose.lua
local Themes_Rose = (function()
return {
	Name = "Rose",
...
return {
    ...
    ['Icons.lua'] = Icons,
    ['init.lua'] = init,
    ['Acrylic/AcrylicBlur.lua'] = Acrylic_AcrylicBlur,
    ['Acrylic/AcrylicPaint.lua'] = Acrylic_AcrylicPaint,
    ['Acrylic/CreateAcrylic.lua'] = Acrylic_CreateAcrylic,
    ['Acrylic/init.lua'] = Acrylic_init,
    ['Acrylic/Utils.lua'] = Acrylic_Utils,
    ['Components/Assets.lua'] = Components_Assets,
    ['Components/Button.lua'] = Components_Button,
    ['Components/Dialog.lua'] = Components_Dialog,
    ['Components/Element.lua'] = Components_Element,
    ['Components/Notification.lua'] = Components_Notification,
    ['Components/Section.lua'] = Components_Section,
    ['Components/Tab.lua'] = Components_Tab,
    ['Components/Textbox.lua'] = Components_Textbox,
    ['Components/TitleBar.lua'] = Components_TitleBar,
    ['Components/Window.lua'] = Components_Window,
    ['Elements/Button.lua'] = Elements_Button,
    ['Elements/Colorpicker.lua'] = Elements_Colorpicker,
    ['Elements/Dropdown.lua'] = Elements_Dropdown,
    ['Elements/init.lua'] = Elements_init,
    ['Elements/Input.lua'] = Elements_Input,
    ['Elements/Keybind.lua'] = Elements_Keybind,
    ['Elements/Paragraph.lua'] = Elements_Paragraph,
    ['Elements/Slider.lua'] = Elements_Slider,
    ['Elements/Toggle.lua'] = Elements_Toggle,
    ['Packages/Flipper/BaseMotor.lua'] = Packages_Flipper_BaseMotor,
    ['Packages/Flipper/BaseMotor.spec.lua'] = Packages_Flipper_BaseMotor.spec,
    ['Packages/Flipper/GroupMotor.lua'] = Packages_Flipper_GroupMotor,
    ['Packages/Flipper/GroupMotor.spec.lua'] = Packages_Flipper_GroupMotor.spec,
    ['Packages/Flipper/init.lua'] = Packages_Flipper_init,
    ['Packages/Flipper/Instant.lua'] = Packages_Flipper_Instant,
    ['Packages/Flipper/Instant.spec.lua'] = Packages_Flipper_Instant.spec,
    ['Packages/Flipper/isMotor.lua'] = Packages_Flipper_isMotor,
    ['Packages/Flipper/isMotor.spec.lua'] = Packages_Flipper_isMotor.spec,
    ['Packages/Flipper/Linear.lua'] = Packages_Flipper_Linear,
    ['Packages/Flipper/Linear.spec.lua'] = Packages_Flipper_Linear.spec,
    ['Packages/Flipper/Signal.lua'] = Packages_Flipper_Signal,
    ['Packages/Flipper/Signal.spec.lua'] = Packages_Flipper_Signal.spec,
    ['Packages/Flipper/SingleMotor.lua'] = Packages_Flipper_SingleMotor,
    ['Packages/Flipper/SingleMotor.spec.lua'] = Packages_Flipper_SingleMotor.spec,
    ['Packages/Flipper/Spring.lua'] = Packages_Flipper_Spring,
    ['Packages/Flipper/Spring.spec.lua'] = Packages_Flipper_Spring.spec,
    ['Themes/Amethyst.lua'] = Themes_Amethyst,
    ['Themes/Aqua.lua'] = Themes_Aqua,
    ['Themes/Dark.lua'] = Themes_Dark,
    ['Themes/Darker.lua'] = Themes_Darker,
    ['Themes/init.lua'] = Themes_init,
    ['Themes/Light.lua'] = Themes_Light,
    ['Themes/Rose.lua'] = Themes_Rose,
}
